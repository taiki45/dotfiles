...
#%(?,${GREEN}✔,${RED}✗) ${RESET}'
    ...
    PROMPT='%F{22}%K{70} ${USER} %k%f%F{70}%K{238}⮀⮁ %k%f%F{238}%K{208}⮀  %k%f%F{208}%K{236}⮀%k%f%F{214}%K{236} %(10~,%-2~/.../%2~,%~)%  %k%f%F{236}%K{208}⮀ %k%f%F{208}%K{240}⮀ %k%f%F{240}%K{45}⮀%F{45}%K{240}⮀%F{240}%K{45}⮀%F{25}%K{45} %1(v|%1v|) %F{45}%K{67}⮀%F{67}%K{239}⮀%F{239}%K{0}⮀ %f%k
